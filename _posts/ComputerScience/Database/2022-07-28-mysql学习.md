...
| =                   | 等于                                        |
| <> 或 !=            | 不等于                                      |
| BETWEEN ... AND ... | 在某个范围内（先最小、后最大值) 替代范围值 and|
| IN(...)             | 在in之后的列表中的值，多选一,替代多个or情况  |
...
![结构图](/assets/img/post/2022-07-28-mysql学习20220728223208.png "结构图")

![层级描述](/assets/img/post/2022-07-28-mysql学习20220728223258.png "层级描述")
...
![InnoDB逻辑存储结构](/assets/img/post/2022-07-28-mysql学习20220728223335.png "InnoDB逻辑存储结构")
...
![二叉树](/assets/img/post/2022-07-28-mysql学习20220728223357.png "二叉树")

二叉树的缺点可以用红黑树来解决：
![红黑树](/assets/img/post/2022-07-28-mysql学习20220728223427.png "红黑树")
红黑树也存在大数据量情况下，层级较深，检索速度慢的问题。

为了解决上述问题，可以使用 B-Tree 结构。
B-Tree (多路平衡查找树) 以一棵最大度数（max-degree，指一个节点的子节点个数）为5（5阶）的 b-tree 为例（每个节点最多存储4个key，5个指针）

![B-Tree结构](/assets/img/post/2022-07-28-mysql学习20220728223452.png "B-Tree结构")
...
结构图：
![B+Tree结构图](/assets/img/post/2022-07-28-mysql学习20220728223521.png "B+Tree结构图")
...
![MySQL B+Tree 结构图](/assets/img/post/2022-07-28-mysql学习20220728223548.png "MySQL B+Tree 结构图")

##### Hash

哈希索引就是采用一定的hash算法，将键值换算成新的hash值，映射到对应的槽位上，然后存储在hash表中。
如果两个（或多个）键值，映射到一个相同的槽位上，他们就产生了hash冲突（也称为hash碰撞），可以通过链表来解决。
![Hash索引原理图](/assets/img/post/2022-07-28-mysql学习20220728223610.png  "Hash索引原理图")
...
演示图：
![大致原理](/assets/img/post/2022-07-28-mysql学习20220728223653.png "大致原理")

![演示图](/assets/img/post/2022-07-28-mysql学习20220728223718.png "演示图")
